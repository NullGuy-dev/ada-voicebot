...
main = Thread(target=funcs.mainDB_BOT, args=())
newyear = Thread(target=funcs.newYear, args=())

main.start()
newyear.start()

for text in funcs.listen():
    funcs.mainDB_BOT(text, settingsFile, botQueryData)
